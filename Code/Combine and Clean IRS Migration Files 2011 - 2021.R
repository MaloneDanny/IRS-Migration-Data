#This Script prepares the migration data used for my thesis;  for annotations and commentary, please see either the other script or the readme file.
################### Set-up Chunk ########
...
setwd('D:/Github/IRS-Migration-Data/Pre-2011/county1011')
